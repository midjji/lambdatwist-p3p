...
//E=Matrix<T,3,3>(v1[0],a1,a21,  v1[1],a2,a22,  v1[2],rnorm,rnorm2);

    // actually slower, likely due to inplace comp...
//E[0]=v1[0];E[1]=v2[0];E[2]=v3[0];
//E[3]=v1[1];E[4]=v2[1];E[5]=v3[1];
//E[6]=v1[2];E[7]=v2[2];E[8]=v3[2];
